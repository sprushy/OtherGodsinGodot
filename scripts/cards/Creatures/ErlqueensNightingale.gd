...
func _init() -> void:
	...
	strength = 13
	sacrifice_cost = 0
	ability_text = "[b]Easy Transition[/b] ([b]Passive[/b]): This card's shifting is free.\n[b]Shift[/b] ([b]Activate[/b]): Switch this card between Human, Servant, Mage, Witch and Animal, Avian, Aerial. When this card shifts, you may return it to your hand."
	flavor_text = ""
	culture = "Norse"
...
func can_activate(game_manager: GameManager) -> bool:
	...
	if is_sleeping:
		return false
	return can_use_shift_ability_this_turn()
...
func get_hover_detail_lines(_viewer: Player = null) -> Array[String]:
	var active_form := _get_bird_form_types() if in_bird_form else _get_human_form_types()
	var inactive_form := _get_human_form_types() if in_bird_form else _get_bird_form_types()
	return [
