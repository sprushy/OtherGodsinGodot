...
func _init() -> void:
	...
	level = 1
	targets = true
	ability_text = "Pay %d mana. If equipped to a Mage, put a creature to [b]Sleep[/b] until end of turn. If equipped to a Shaman, it may instead switch a defensive creature to aggressive stance until end of turn. Only Mages and Shamans can equip this card." % ACTIVATION_COST
	flavor_text = ""
