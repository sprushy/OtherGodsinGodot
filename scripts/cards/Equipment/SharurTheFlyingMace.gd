...
func _init() -> void:
	...
	strength_modifier = 9
	is_legendary = true
	ability_text = "Can be equipped to Ancient creatures, Warriors, and Demons. Gain 9 Str. If this unequipped card is on the field, equip it to a friendly Ancient Warrior or Demon when available (Spd 3). If this card would be destroyed or stolen, you may pay 4 mana and return it to your hand instead (Spd 3)."
	flavor_text = ""
