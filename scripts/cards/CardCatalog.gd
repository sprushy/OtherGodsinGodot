...
static func make_all_cards() -> Array:
	return [
		...
		Berserker.new(), Beyla.new(), BlessedKnights.new(), BrownBear.new(), Byggvir.new(), DurinnSecondborn.new(), Fenrir.new(), FirstSageAdapa.new(), load("res://scripts/cards/Creatures/FourthSageEnmegalamma.gd").new(), GiantMasterArchitect.new(), HariiFransiscan.new(), load("res://scripts/cards/Creatures/HariiJarl.gd").new(), Skoll.new(), AnkouServantToTheReaper.new(), Anzu.new(), AnTheBowbender.new(),
