...
func _init() -> void:
	...
	ability_text = "Giants you control treat non-Giant opponents' stats as half (rounded down) when calculating follower damage, and gain +1 Reach and +1 Speed when intercepting non-Giant creatures."
	art_path = ART_PATH
